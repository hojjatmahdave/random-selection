...
const Card = ({ index, item, Filter }: Props) => {
  return (
    <section
      key={index}
      className="rounded-xl shadow-xl p-4 m-4 bg-gradient-to-r from-blue-800 to-indigo-900 w-96 h-32 flex flex-row items-center hover:scale-105 transition-all border-2 border-solid border-blue-500 hover:border-blue-400 hover:from-indigo-900 hover:to-blue-800 cursor-pointer"
    >
      <p
